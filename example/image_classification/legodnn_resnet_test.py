...
if __name__ == '__main__':
    ...
    teacher_model.load_state_dict(torch.load('../../data/model/resnet110/resnet18.pth')['net'])                               #踩坑？路径修改  No such file or directory: 'data/model/resnet110/resnet18.pth'
    ...
    block_trainer.train_all_blocks()                                                                                            ##踩坑
    ...
    # gen_series_legodnn_models(deadline=100, model_size_search_range=[15,50], target_model_num=50, optimal_runtime=optimal_runtime, descendant_models_save_path=descendant_models_dir_path, device=device)
